          ...
          <div className="home">
            <div className="flex flex-col sm:flex-row p-4 sm:p-10  ancjor">
              <div className="text-center px-4 mb-4 sm:mb-0 ">
                  ...
                  <Link href="/Series" className="block max-w-sm py-16 px-8 sm:py-24 sm:px-12 bg-dark bgone border  border-gray-200 shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
              ...
              <div className="text-center px-4 mb-4 sm:mb-0">
                  ...
                  <Link href="/Movies" className="block max-w-sm py-16 px-8 sm:py-24 sm:px-12 bg-white bgone border border-gray-200 shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
